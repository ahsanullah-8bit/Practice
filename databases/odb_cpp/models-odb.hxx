...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::User, id_sqlite, A >::name_type_
  query_columns< ::User, id_sqlite, A >::
  ...
  //
  template <typename A>
  struct query_columns< ::Task, id_sqlite, A >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::Task, id_sqlite, A >::id_type_
  query_columns< ::Task, id_sqlite, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::Task, id_sqlite, A >::description_type_
  query_columns< ::Task, id_sqlite, A >::
  description (A::table_name, "\"description\"", 0);

  template <typename A>
  const typename query_columns< ::Task, id_sqlite, A >::priority_type_
  query_columns< ::Task, id_sqlite, A >::
  priority (A::table_name, "\"priority\"", 0);

  template <typename A>
  struct pointer_query_columns< ::Task, id_sqlite, A >:
    query_columns< ::Task, id_sqlite, A >
  {
  };

  template <>
  class access::object_traits_impl< ::Task, id_sqlite >:
  ...
  class access::object_traits_impl< ::Task, id_common >:
    public access::object_traits_impl< ::Task, id_sqlite >
  {
  };
